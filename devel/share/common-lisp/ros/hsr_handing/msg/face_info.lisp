...
(cl:defmethod cl:initialize-instance :after ((m <face_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'face_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hsr_handing-msg:<face_info> is deprecated: use hsr_handing-msg:face_info instead.")))

(cl:ensure-generic-function 'face_depth-val :lambda-list '(m))
(cl:defmethod face_depth-val ((m <face_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hsr_handing-msg:face_depth-val is deprecated.  Use hsr_handing-msg:face_depth instead.")
  (face_depth m))

(cl:ensure-generic-function 'center_depth-val :lambda-list '(m))
(cl:defmethod center_depth-val ((m <face_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hsr_handing-msg:center_depth-val is deprecated.  Use hsr_handing-msg:center_depth instead.")
  (center_depth m))

(cl:ensure-generic-function 'face_x-val :lambda-list '(m))
(cl:defmethod face_x-val ((m <face_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hsr_handing-msg:face_x-val is deprecated.  Use hsr_handing-msg:face_x instead.")
  (face_x m))

(cl:ensure-generic-function 'face_y-val :lambda-list '(m))
(cl:defmethod face_y-val ((m <face_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hsr_handing-msg:face_y-val is deprecated.  Use hsr_handing-msg:face_y instead.")
  (face_y m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <face_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hsr_handing-msg:time-val is deprecated.  Use hsr_handing-msg:time instead.")
  (time m))
