...
(cl:in-package pre_experiment-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <input4handing-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'input4handing-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pre_experiment-srv:<input4handing-request> is deprecated: use pre_experiment-srv:input4handing-request instead.")))

(cl:ensure-generic-function 'input_key-val :lambda-list '(m))
(cl:defmethod input_key-val ((m <input4handing-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pre_experiment-srv:input_key-val is deprecated.  Use pre_experiment-srv:input_key instead.")
  (input_key m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<input4handing-request>)))
  ...
  "pre_experiment/input4handingRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'input4handing-request)))
  "Returns string type for a service object of type 'input4handing-request"
  "pre_experiment/input4handingRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <input4handing-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'input4handing-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pre_experiment-srv:<input4handing-response> is deprecated: use pre_experiment-srv:input4handing-response instead.")))

(cl:ensure-generic-function 'action_name-val :lambda-list '(m))
(cl:defmethod action_name-val ((m <input4handing-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pre_experiment-srv:action_name-val is deprecated.  Use pre_experiment-srv:action_name instead.")
  (action_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<input4handing-response>)))
  ...
  "pre_experiment/input4handingResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'input4handing-response)))
  "Returns string type for a service object of type 'input4handing-response"
  "pre_experiment/input4handingResponse")
