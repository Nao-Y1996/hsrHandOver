...
(cl:defmethod cl:initialize-instance :after ((m <grasp_key>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'grasp_key)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pre_experiment-msg:<grasp_key> is deprecated: use pre_experiment-msg:grasp_key instead.")))

(cl:ensure-generic-function 'grasp_key-val :lambda-list '(m))
(cl:defmethod grasp_key-val ((m <grasp_key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pre_experiment-msg:grasp_key-val is deprecated.  Use pre_experiment-msg:grasp_key instead.")
  (grasp_key m))
