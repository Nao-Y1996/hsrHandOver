...
if __name__ == '__main__':
    ...
    joint_path = '/home/kubotalab/catkin_ws3/src/hsr_handing/script/csv/raw-joint.csv'
    f=open(joint_path, 'w')
    f.close
    train_path = '/home/kubotalab/catkin_ws3/src/hsr_handing/script/csv/nn-train-data.csv'
    f=open(train_path, 'w')
    f.close
    count = 0
    #for i in range(10):
