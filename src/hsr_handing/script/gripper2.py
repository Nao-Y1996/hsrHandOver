...
def gripper_operating(data):
	...
	#print('---------Fuzzy----------')
        ...
        if pose_num == 0:
            force_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_sit.csv'
	    print('力書き込み時---sitting')
            pose_fig_path = 'sit'
        if pose_num == 1:
            force_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_stand.csv'
	    print('力書き込み時---standing')
            pose_fig_path = 'stand'
        if pose_num == 2:
            force_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_cross.csv'
	    print('力書き込み時---cross')
            pose_fig_path = 'cross'
        if pose_num == 3:
            force_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_unknown.csv'
	    print('力書き込み時---unknown')
...
#------------------------------------------------------------------------------#
	...
	#param.old_fz = fz 
        ...
        saving_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/figure/'+ pose_fig_path + figure_name
        plt.tight_layout()
...
if __name__ == '__main__':
	...
	sub_pose = Sub_Pose_estimation()
        ...
        sensor_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/sensor_data.csv'
