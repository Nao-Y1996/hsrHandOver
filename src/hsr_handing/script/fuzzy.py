...
class Fuzzy_inference():
    ...
    def fuzzy4angle(self, x,dx):
        ...
        w1 = l_edge_fuzzy(-4.0,-2.0,x) * l_edge_fuzzy(-0.7,0.0,dx)
        w2 = l_edge_fuzzy(-4.0,-2.0,x) * triangle_fuzzy(-0.2,0.0,-0.2,dx)
        w3 = l_edge_fuzzy(-4.0,-2.0,x) * r_edge_fuzzy(-0.7,0.0,dx)

        w4 = r_edge_fuzzy(2.0,4.0,x) * l_edge_fuzzy(-0.7,0.0,dx)
	w5 = r_edge_fuzzy(2.0,4.0,x) * triangle_fuzzy(-0.2,0.0,-0.2,dx)
	w6 = r_edge_fuzzy(2.0,4.0,x) * r_edge_fuzzy(0.0,0.7,dx)
...
def callback(req):
    ...
    pose_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/pose.csv'
    ...
    if pose_num == 0:
        param_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/handing_param/handing_param_sit.csv'
	ForceXY_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/Force_XY/sit.csv'
	print('Fuzzy時---sitting')
    if pose_num == 1:
        param_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/handing_param/handing_param_stand.csv'
	ForceXY_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/Force_XY/stand.csv'
	print('Fuzzy時---standing')
    if pose_num == 2:
        param_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/handing_param/handing_param_cross.csv'
	ForceXY_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/Force_XY/cross.csv'
	print('Fuzzy時---cross')
    if pose_num == 3:
        param_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/handing_param/handing_param_unknown.csv'
	ForceXY_path = '/home/naoyamada/CW/catkin_ws3/src/hsr_handing/script/csv/Force_XY/unknown.csv'
	print('Fuzzy時---unknown')
    ...
    old_F = [oldFX, oldFY]
    #-------------------------------------------
    F = calc.get_force(fx,fy,old_ek)


    print('(fx, fy, ek) = ({}, {}, {})'.format(round(fx,3),round(fy,3),round(old_ek,3)))
...
if __name__=="__main__":
    ...
    #param_path = '/home/kubotalab/catkin_ws3/src/hsr_handing/script/csv/param.csv'
