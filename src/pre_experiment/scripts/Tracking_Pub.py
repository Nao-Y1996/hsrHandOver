...
class getIm_from_HSR(object):
	...
	self.sub_count_dep = 0
        ...
        rospy.wait_for_message(rgb, Image, timeout=5.0)
        rospy.wait_for_message(depth, Image, timeout=5.0)
...
class face_detection():
    ...
    def detect(self,input_image):
        ...
        cascade_path = r'/home/naoyamada/catkin_ws3/src/pre_experiment/scripts/haarcascades/haarcascade_frontalface_alt2.xml'
