...
if __name__ == '__main__':
    try: 
        ...
        #csvファイルの準備
        path = '/home/naoyamada/catkin_ws3/src/pre_experiment/scripts/csv/r45/raw_data.csv'
        path2 = '/home/naoyamada/catkin_ws3/src/pre_experiment/scripts/csv/r45/ave_data.csv'
	os.remove(path)
        f= open(path, 'w')
        f.close
	os.remove(path2)
